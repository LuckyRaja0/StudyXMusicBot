...
from StudyXMusic.utils.database import get_authuser_names, get_cmode
from StudyXMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from StudyXMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await StudyX.stop_stream(message.chat.id)
    except:
        pass
